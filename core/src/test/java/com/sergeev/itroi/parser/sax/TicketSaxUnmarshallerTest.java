...
class TicketSaxUnmarshallerTest {
    ...
    void shouldUnmarshalValidXml() {
        XmlUnmarshaller<TicketArray> unmarshaller = new TicketSaxUnmarshaller(validationSchema);
    ...
    void shouldUnmarshalValidXmlWithoutValidationSchema() {
        XmlUnmarshaller<TicketArray> unmarshaller = new TicketSaxUnmarshaller();
